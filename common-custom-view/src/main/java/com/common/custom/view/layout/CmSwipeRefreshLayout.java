 ...
 * ********************************************************
 */
package com.common.custom.view.layout;
...
public class CmSwipeRefreshLayout extends SwipeRefreshLayout {
	...
	public CmSwipeRefreshLayout(Context context, AttributeSet attrs) {
		super(context, attrs);
		setColorSchemeResources(android.R.color.holo_green_dark, android.R.color.holo_blue_dark,
